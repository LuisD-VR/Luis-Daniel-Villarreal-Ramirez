...
selected = StringVar()
value=StringVar()
rad1 = Radiobutton(windows,text='Aguascalientes     ',value='Aguascalientes',variable=selected)
rad2 = Radiobutton(windows,text='Baja California    ',value='Baja California', variable=selected)
rad3 = Radiobutton(windows,text='B. California Sur  ',value='Baja California Sur', variable=selected)
rad4 = Radiobutton(windows,text='Campeche           ',value='Campeche',variable=selected)
rad5 = Radiobutton(windows,text='Chiapas            ',value='Chiapas',variable=selected)
rad6 = Radiobutton(windows,text='Chihuahua          ',value='Chihuahua',variable=selected)
rad7 = Radiobutton(windows,text='Coahuila           ',value='Coahuila',variable=selected)
rad8 = Radiobutton(windows,text='Colima             ',value='Colima',variable=selected)
rad9 = Radiobutton(windows,text='Durango            ',value='Durango',variable=selected)
rad10 = Radiobutton(windows,text='Guanajuato         ',value='Guanajuato',variable=selected)
rad11 = Radiobutton(windows,text='Guerrero           ',value='Guerrero',variable=selected)
rad12 = Radiobutton(windows,text='Hidalgo            ',value='Hidalgo',variable=selected)
rad13 = Radiobutton(windows,text='Jalisco            ',value='Jalisco',variable=selected)
rad14 = Radiobutton(windows,text='Edo. México        ',value='Edo. México',variable=selected)
rad15 = Radiobutton(windows,text='Michoacan          ',value='Michoacan',variable=selected)

def clicked():
    itemfound = lineaSearch(selected.get(),bolsa)
    if itemfound:
       data={}
       data['Aguascalientes']=[]
       ...
       for c in data[selected.get()]:
        ...
        with open('Datos COVID de '+selected.get(),'w') as file:
            json.dump(data[selected.get()],file)
        with open('Datos COVID de '+selected.get()) as file:
            data=json.load(file)
